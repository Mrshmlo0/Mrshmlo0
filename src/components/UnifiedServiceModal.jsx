      ...
      <div className="relative w-full max-w-5xl max-h-[92vh] bg-slate-900 border border-slate-800 rounded-3xl shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="bg-slate-950/80 p-3.5 rounded-2xl border border-slate-800 text-xs flex items-center justify-between">
              <span className="text-slate-400">استهلاك العملية:</span>
            ...
            <form onSubmit={handleExecute} className="space-y-3.5">
          ...
          <div className="lg:col-span-7 bg-slate-950/90 rounded-3xl p-5 sm:p-6 border border-slate-800 shadow-xl flex flex-col justify-between">
            <div>
              ...
              {service.id === 'midjourney-prompts' ? (
                ...
                <div className="space-y-4 animate-fadeIn text-xs sm:text-sm">
                  ...
                  <div className="p-4 bg-slate-900/90 rounded-2xl border border-slate-800 max-h-72 overflow-y-auto scrollbar-thin">
                    ...
                    <pre className="text-xs sm:text-sm font-sans text-slate-200 whitespace-pre-line leading-relaxed">
                  ...
                  <div className="p-3 bg-amber-950/30 rounded-2xl border border-amber-500/30 text-xs">
                    <span className="text-amber-400 font-bold block mb-1">🎯 التوصية والخطوة التالية:</span>
                    <p className="text-slate-200">{generationResult.output.callToAction}</p>
                  </div>
                </div>
              ) : (
                <div className="py-20 sm:py-28 text-center text-slate-500">
                  <Sparkles className="w-12 h-12 text-slate-700 mx-auto mb-3 animate-bounce" />
                  <p className="text-sm font-bold text-slate-300">مساحة العمل جاهزة للتوليد الحقيقي</p>
                  <p className="text-xs text-slate-500 mt-1">اكتب مواصفاتك واضغط زر التوليد للحصول على المخرجات الكاملة.</p>
                </div>
              )}
            </div>
